...
TRAIN_NOTE="GAM released recipe on four DexJoCo bimanual tasks: T9 H1 K8, all three cameras, batch256, 30k, 4 GPUs"
...
EVAL_NUM_GPUS=4
# Match the original GAM eval recipe (dexjoco_gam_bimanual_5tasks_224): 4 GPUs x 4 envs.
N_ENVS_PER_GPU=4
N_EPISODES=50
N_RUNS=3
EVAL_SETS=(rand_obj)
