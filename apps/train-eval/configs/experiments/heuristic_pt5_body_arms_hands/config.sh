# Experiment: heuristic_pt5_body_arms_hands
...
# 2 left arm: L_Shoulder_*, L_Elbow, L_Wrist_*
# 3 right arm: R_Shoulder_*, R_Elbow, R_Wrist_*
# 4 left hand: all left hand joints
# 5 right hand: all right hand joints
TRAIN_EXTRA_ARGS=(
    --state-part-mode
    explicit
...
TRAIN_NOTE="PoC2 heuristic state tokens K=5: body, left/right arms, left/right hands; PhysiXel 9f731f9, AH16"
