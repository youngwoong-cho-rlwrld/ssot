# Variant: n16_cylinder_tube_place_5cm_right_480
...
TASKS=(
    "__single__|task-Cylinder_Tube_Place-T15cmC5cmRight|Lift the cylinder with your right hand and place it in the middle of the tube without touching the tube."
)
