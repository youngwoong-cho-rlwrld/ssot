# Experiment: physixel_poc3_ag5_ps2
...
TRAIN_NOTE="PoC3 action part tokens G=5 seed=2 random_balanced + state tokens K=15 seed=2; bs128 recipe (2x64); PhysiXel feature/physixel-poc3-action-part-tokens ce6403d, AH16"
