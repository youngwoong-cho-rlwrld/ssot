# Experiment: physixel_poc3_control_pt15_ps2
...
TRAIN_NOTE="PoC3/PoC4 control: state tokens K=15 seed=2 random_balanced, no action split, shared encoder; settled bs512 recipe (2x256); PhysiXel base 9f731f9, AH16"
