# Experiment: physixel_poc4_film_ps0
...
TRAIN_NOTE="PoC4 state encoder mode film + state tokens K=15 seed=0; bs128 recipe (2x64), control=PoC1 pt15 공유; PhysiXel feature/physixel-poc4-part-specific-state-encoder c2f932c, AH16"
