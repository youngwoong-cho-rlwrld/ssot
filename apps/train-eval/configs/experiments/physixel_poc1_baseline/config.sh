# Experiment: physixel_poc1_baseline
# PhysiXel PoC1 one-token baseline on 3 V4 sim datasets at 480x640, AH16.
...
TRAIN_EXTRA_ARGS=()
TRAIN_NOTE="PoC1 one-token baseline; PhysiXel feature/physixel-poc1-part-state-tokens d930025, AH16"
