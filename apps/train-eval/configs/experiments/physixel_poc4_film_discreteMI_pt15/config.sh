# Experiment: physixel_poc4_film_discreteMI_pt15
# PhysiXel PoC4 part-specific state encoder (film) + discrete-MI explicit state tokens, bs128 recipe, on 3 V4 sim datasets at 480x640, AH16.
...
# matches baseline discrete_MI_pt15_random_33; FiLM modulates layer1 hidden per part id.
...
TRAIN_NOTE="PoC4 state encoder mode film + discrete-MI explicit tokens K=15 random-33 (ratio 1.696); bs128 recipe (2x64), grouping=discrete_MI_pt15_random_33; PhysiXel c2f932c, AH16"
