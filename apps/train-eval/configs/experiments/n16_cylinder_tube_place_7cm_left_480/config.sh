# Variant: n16_cylinder_tube_place_7cm_left_480
...
TASKS=(
    "__single__|task-Cylinder_Tube_Place-T15cmC7cmLeft|Lift the cylinder with your left hand and place it in the middle of the tube without touching the tube."
)
