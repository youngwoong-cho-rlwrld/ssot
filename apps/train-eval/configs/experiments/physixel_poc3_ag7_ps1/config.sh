# Experiment: physixel_poc3_ag7_ps1
...
TRAIN_NOTE="PoC3 action part tokens G=7 seed=1 random_balanced + state tokens K=15 seed=1; bs128 recipe (2x64); PhysiXel feature/physixel-poc3-action-part-tokens ce6403d, AH16"
