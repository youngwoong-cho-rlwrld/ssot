# Experiment: physixel_poc5_film_ps2
# PhysiXel PoC5 action encoder mode=film on action part tokens (G=3) + state tokens K=15, bs128, on 3 V4 sim datasets at 480x640, AH16.
...
TRAIN_NOTE="PoC5 action encoder mode=film + action part tokens G=3 seed=2 + state tokens K=15 seed=2; bs128 (2x64); control=PoC3 ag3; PhysiXel feature/physixel-poc5-action-encoder-modes 97597a5, AH16"
