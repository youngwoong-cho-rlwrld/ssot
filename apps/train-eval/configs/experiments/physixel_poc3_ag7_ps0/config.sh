# Experiment: physixel_poc3_ag7_ps0
...
TRAIN_NOTE="PoC3 action part tokens G=7 seed=0 random_balanced + state tokens K=15 seed=0; bs128 recipe (2x64); PhysiXel feature/physixel-poc3-action-part-tokens ce6403d, AH16"
