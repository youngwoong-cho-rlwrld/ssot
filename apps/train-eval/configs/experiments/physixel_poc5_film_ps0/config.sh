# Experiment: physixel_poc5_film_ps0
...
TRAIN_NOTE="PoC5 action encoder mode=film + action part tokens G=3 seed=0 + state tokens K=15 seed=0; bs128 (2x64); control=PoC3 ag3; PhysiXel feature/physixel-poc5-action-encoder-modes 97597a5, AH16"
