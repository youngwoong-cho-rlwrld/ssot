# Experiment: physixel_poc4_film_ps1
# PhysiXel PoC4 part-specific state encoder (film) + state tokens, bs128 recipe, on 3 V4 sim datasets at 480x640, AH16.
...
TRAIN_NOTE="PoC4 state encoder mode film + state tokens K=15 seed=1; bs128 recipe (2x64), control=PoC1 pt15 공유; PhysiXel feature/physixel-poc4-part-specific-state-encoder c2f932c, AH16"
