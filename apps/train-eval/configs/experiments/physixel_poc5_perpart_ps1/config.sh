# Experiment: physixel_poc5_perpart_ps1
...
TRAIN_NOTE="PoC5 action encoder mode=per_part + action part tokens G=3 seed=1 + state tokens K=15 seed=1; bs128 (2x64); control=PoC3 ag3; PhysiXel feature/physixel-poc5-action-encoder-modes 97597a5, AH16"
