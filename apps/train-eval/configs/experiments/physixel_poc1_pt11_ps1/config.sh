# Experiment: physixel_poc1_pt11_ps1
...
TRAIN_NOTE="PoC1 random-balanced state tokens K=11 seed=1; PhysiXel feature/physixel-poc1-part-state-tokens d930025, AH16"
