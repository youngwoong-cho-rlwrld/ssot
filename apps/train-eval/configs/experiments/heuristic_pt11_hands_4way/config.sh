# Experiment: heuristic_pt11_hands_4way
...
TRAIN_NOTE="PoC2 heuristic state tokens K=11: body, arms, each hand split into thumb/index/middle/rest; PhysiXel 9f731f9, AH16"
