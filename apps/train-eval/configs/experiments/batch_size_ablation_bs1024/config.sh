# Experiment: batch_size_ablation_bs1024
# GR00T N1.6 batch-size ablation on 3 V4 sim datasets at 480x640.
...
TRAIN_EXTRA_ARGS=()
TRAIN_NOTE="GR00T N1.6 batch-size ablation on 3 V4 sim datasets at 480x640; global batch size 1024; all other settings match n16_multitask_3tasks_480"
