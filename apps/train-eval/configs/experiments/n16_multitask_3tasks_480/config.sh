# Variant: n16_multitask_3tasks_480
# GR00T N1.6 multi-task fine-tune on 3 V4 sim datasets at 480x640:
#   - Cube_Box-5cmLeft
#   - Cube_Stack-3cmRight
#   - Cylinder_Tube_Place-T15cmC7cmLeft
# Mirrors n15_multitask_3tasks_480 but uses N1.6 (TRAIN_DATASET_NAMES array
# instead of DATASETS; per-dataset weights/cfg are handled in the modality
# config python file, not bash).
...
TRAIN_EXTRA_ARGS=()
TRAIN_NOTE="N1.6 multi-task @ 480x640 on 3 sim datasets"
