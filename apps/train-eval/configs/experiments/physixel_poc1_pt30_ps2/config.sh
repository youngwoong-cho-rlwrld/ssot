# Experiment: physixel_poc1_pt30_ps2
...
TRAIN_NOTE="PoC1 random-balanced state tokens K=30 seed=2; PhysiXel feature/physixel-poc1-part-state-tokens d930025, AH16"
