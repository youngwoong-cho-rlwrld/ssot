# Variant: n16_cylinder_tube_pick_5cm_right_480
...
TASKS=(
    "__single__|task-Cylinder_Tube_Pick-T15cmC5cmRight|Lift up the cylinder with your right hand, making sure not to touch the tube."
)
