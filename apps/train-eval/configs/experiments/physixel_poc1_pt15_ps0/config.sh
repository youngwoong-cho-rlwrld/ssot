# Experiment: physixel_poc1_pt15_ps0
...
TRAIN_NOTE="PoC1 random-balanced state tokens K=15 seed=0; PhysiXel feature/physixel-poc1-part-state-tokens d930025, AH16"
