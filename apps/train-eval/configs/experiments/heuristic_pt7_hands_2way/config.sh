# Experiment: heuristic_pt7_hands_2way
...
# 2 left arm
# 3 right arm
# 4 left hand: thumb + index
# 5 left hand: middle + ring + little
# 6 right hand: thumb + index
# 7 right hand: middle + ring + little
TRAIN_EXTRA_ARGS=(
    --state-part-mode
    explicit
...
TRAIN_NOTE="PoC2 heuristic state tokens K=7: body, arms, each hand split into thumb+index/rest; PhysiXel 9f731f9, AH16"
