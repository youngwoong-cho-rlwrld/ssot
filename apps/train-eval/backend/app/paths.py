...
# configs/ and lib/ are siblings of backend/ inside apps/train-eval, so the
# repo root is two levels up from this file (app/ -> backend/ -> train-eval/).
# Override with TRAIN_EVAL_ROOT when the app tree lives elsewhere.
_ENV_ROOT = os.environ.get("TRAIN_EVAL_ROOT")
