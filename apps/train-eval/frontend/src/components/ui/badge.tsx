...
const badgeVariants = cva(
  "inline-flex items-center rounded-md border px-2 py-0.5 font-sans text-xs font-semibold transition-colors",
  {
    variants: {
      variant: {
        default: "border-transparent bg-[var(--ssot-text)] text-[var(--ssot-bg)]",
        secondary: "border-transparent bg-[var(--ssot-surface-muted)] text-[var(--ssot-text-soft)]",
        outline: "border-[var(--ssot-border-strong)] text-[var(--ssot-text)]",
