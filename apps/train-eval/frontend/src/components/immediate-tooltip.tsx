      ...
      {visible && typeof document !== "undefined"
        ? createPortal(
            <span
              ...
              role="tooltip"
              className={cn(
                "pointer-events-none fixed z-[1000] w-max max-w-[min(32rem,calc(100vw-2rem))] whitespace-normal rounded-md border border-[var(--ssot-border)] bg-[var(--ssot-surface)] px-2 py-1 text-xs font-normal leading-snug text-[var(--ssot-text)] shadow-lg [overflow-wrap:anywhere]",
                contentClassName,
              )}
