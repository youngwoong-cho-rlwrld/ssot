  ...
  return (
    <Card className={className}>
      <CardHeader>
        <CardTitle>
          config.sh{" "}
          <span className="text-xs font-normal text-[var(--ssot-text-soft)]">
            {loading
              ? "(Loading experiment...)"
          ...
          <div className="space-y-2">
            <div className="overflow-x-auto pb-1">
              <div className="min-w-[42rem]">
                <div className="grid grid-cols-[minmax(8rem,12rem)_minmax(10rem,1fr)_minmax(12rem,18rem)] gap-3 border-b border-slate-100 pb-1 text-xs font-medium uppercase tracking-wide text-[var(--ssot-text-soft)] dark:border-slate-900">
                  <div>Setting</div>
                  <div>Effective</div>
                  <div>Override</div>
                </div>
        ...
        {!loading && !error && variantName && effectiveConfigText && (
          <div className="space-y-2">
            <div className="flex items-center justify-between gap-3">
              <div className="text-xs font-medium uppercase tracking-wide text-[var(--ssot-text-soft)]">
  ...
  return (
    <div className="grid grid-cols-[minmax(8rem,12rem)_minmax(10rem,1fr)_minmax(12rem,18rem)] items-start gap-3 py-2 text-xs">
      ...
      {normalizedEditor?.wide && (
        <div className="col-span-3 rounded-md border border-[var(--ssot-border)] bg-[var(--ssot-surface-muted)] p-3">
...
function ConfigPathRow({
  ...
  const messageClass =
    tone === "error"
      ...
      : "mt-1 pl-[calc(110px+1rem)] text-xs text-[var(--ssot-text-soft)]";
  const shownCopyValue = copyValue === undefined ? value : copyValue;
  return (
    <div className="py-2">
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-[110px] items-center gap-1.5 text-xs uppercase tracking-wide text-[var(--ssot-text-soft)]">
          <span>{label}</span>
          {labelHelp && (
