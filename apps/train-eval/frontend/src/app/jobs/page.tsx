        ...
        <CardContent>
          <div className="mb-5 flex flex-wrap items-end gap-3">
            <div className="space-y-1">
              <Label htmlFor="recent-name" className="text-xs text-[var(--ssot-text-soft)]">Name</Label>
              <Input
                id="recent-name"
            ...
            <div className="space-y-1">
              <Label htmlFor="recent-phase" className="text-xs text-[var(--ssot-text-soft)]">Phase</Label>
            ...
            <div className="space-y-1">
              <Label htmlFor="recent-state" className="text-xs text-[var(--ssot-text-soft)]">State</Label>
            ...
            <div className="space-y-1">
              <Label htmlFor="recent-start" className="text-xs text-[var(--ssot-text-soft)]">From</Label>
              <Input
                id="recent-start"
                type="date"
            ...
            <div className="space-y-1">
              <Label htmlFor="recent-end" className="text-xs text-[var(--ssot-text-soft)]">To</Label>
              <Input
                id="recent-end"
                type="date"
            ...
            return (
              <tr key={`${j.cluster}-${j.job_id}`} className="border-b border-slate-100 last:border-0 hover:bg-slate-50 dark:border-slate-900 dark:hover:bg-slate-900/40">
                <td className="py-2 pr-4 font-mono">
                  ...
                  {j.resume_of && (
                    <span className="ml-1 block max-w-[26ch] text-xs text-[var(--ssot-text-soft)]">
...
function ActiveProgressCell({ job }: { job: Job }) {
  ...
  if (!shouldFetch) {
    ...
    return <span className="text-xs text-[var(--ssot-text-soft)]">{label}</span>;
  }
  ...
  if (progressQuery.error) {
    return (
      <ImmediateTooltip content={(progressQuery.error as Error).message}>
        <span className="text-xs text-[var(--ssot-text-soft)]">unavailable</span>
      </ImmediateTooltip>
    );
  }
  ...
  return (
    <div className="space-y-1.5">
      <div className="flex flex-wrap items-baseline justify-between gap-x-3 gap-y-1 text-xs">
        ...
        <span className="shrink-0 whitespace-nowrap font-mono text-[var(--ssot-text-soft)]">
