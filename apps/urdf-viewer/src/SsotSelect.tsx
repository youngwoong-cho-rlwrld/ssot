 ...
 * Trigger is styled like .ssot-select (compact "pill" variant for joint rows);
 * the panel is portaled to <body> and positioned with fixed coordinates so it
 * escapes the scroll/overflow clipping of the surrounding panels.
 */
  ...
  return (
    <>
      ...
      >
        ...
        <ChevronDown className="ssot-select-arrow" size={variant === "pill" ? 13 : 15} aria-hidden />
      </button>
      {open &&
        pos &&
        createPortal(
